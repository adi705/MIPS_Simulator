...
class Mux(CPUElement):
    ...
    def writeOutput(self):
       ...
       # print('\n%s: %d\n' % (self.controlName, muxControl))
        ...
        #print('    mux.input_zero = %d and mux.input_one = %d' % (self.inputValues[self.inputZero],self.inputValues[self.inputOne],) )
        #print( muxControl )
        ...
        if muxControl == 0:
         ...
         #   print('mux.output = %d if mux control is 1' % (self.outputValues[self.outputName],))
